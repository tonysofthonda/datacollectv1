<%-- 
    Document   : 401 - Unauthorized (No authenticated)
        ...
        <!-- =============================================== -->
            ...
            <div class="content-wrapper">
                ...
                <jsp:include page="../../fragments/template-based/content-header.jsp" flush="false">
                    <jsp:param name="title" value="401"/>
                    <jsp:param name="subtitle" value="Unauthorized"/>
                </jsp:include>
                <!-- /.content-header -->
                ...
                <section class="content">
                    ...
                    <div class="error-page">
                        ...
                        <div class="error-content">
                            <h3><i class="fa fa-warning text-yellow"></i> Oops! You are not authenticated.</h3>

                            <p>
                                Sorry you are not authenticated –either not authenticated 
                                at all or authenticated incorrectly– but please 
