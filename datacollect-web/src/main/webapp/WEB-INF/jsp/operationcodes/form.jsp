...
<body
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<jsp:include page="../../fragments/template-based/content-header.jsp" flush="false">
				<jsp:param name="title" value="Operation Codes" />
				...
				<div class="row">
					<div class="col-md-6">
						<div class="box">
							...
							<!-- /.box-header -->
							<div class="box-body">
								<form:form method="POST" modelAttribute="operationCodeForm" class="form-horizontal">
								
									<form:hidden path="id" />
									<div class="form-group">
										<form:label path="code" class="col-sm-2 control-label">Code</form:label>
										<div class="col-sm-10">
											<form:input path="code" class="form-control" placeholder="Code" maxlength="10" />
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<form:input path="description" class="form-control" placeholder="Description" maxlength="255" />
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<form:select path="serviceType" class="form-control">
												...
												<c:forEach items="${service}" var="item">
									            	<c:choose>
								                        <c:when test="${operationCodeForm.serviceType != null && operationCodeForm.serviceType == item}"> 
								                            <form:option value="${fn:substring(item, 0, 2)}" selected="selected">${operationCodeForm.serviceType}</form:option>
								                        </c:when>
								                        <c:otherwise>
								  	...
								  	<div class="box-footer">
                                       ...
                                       <a href="operationcodes/list" class="btn btn-danger">Cancel</a>                                            
                                     </div>
								</form:form>
							</div>
							<!-- /.box-body -->
	...
	<script src="js/view.operationcodes.form.js"></script>
</body>
