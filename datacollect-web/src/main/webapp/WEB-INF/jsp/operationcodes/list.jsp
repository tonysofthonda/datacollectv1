...
<body
	...
	<div class="wrapper">
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<c:if test="${userPermissionEvaluator.hasPermission('operationcodes', 'create')}">
									<span class="pull-right"> <a href="operationcodes/add"
							...
							<!-- /.box-header -->
							<div class="box-body">
								<table id="operationCodesTable" class="table table-bordered table-striped invisible">
								<thead>
										<tr>
											<th>Code</th>
											<th>Description</th>
									...
									<tbody>
										<c:forEach items="${operationCodeList}" var="model">
											<tr>
												...
												<td>
												<c:if test="${userPermissionEvaluator.hasPermission('operationcodes', 'edit')}">
                                                        	<a href="operationcodes/edit/${model.id}" class="btn btn-xs btn-primary">edit</a>
                                                        </c:if> 
												</td>
											</tr>
										</c:forEach>
        ...
        <script src="js/view.operationcodes.list.js"></script>
        <!-- page script -->
        <script>
        </script>
</body>
