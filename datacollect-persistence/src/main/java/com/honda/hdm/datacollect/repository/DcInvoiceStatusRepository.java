 ...
 */
@Repository
public interface DcInvoiceStatusRepository extends IBaseStatusableRepository<DcInvoiceStatus, BigDecimal>{

    public DcInvoiceStatus findOneByNameIgnoreCase(String name);
